...
import { Wrench, File, Terminal, BookOpen, Brain, Cpu, Hash, Search, ChevronDown } from '@/components/common/icons'
import { t } from '@/i18n'
import type { Component } from 'vue'

/**
 * 工具清单：hero + 搜索 + 6 个工具分组（文件与目录 / 命令与网络 / 文档与知识 /
 * 记忆·计划·委派 / 文本·数据·多媒体 / 纯函数）。
...
/** 固定 6 个分组，id 与后端 tool.GroupOf 返回值一一对应（functools 是第 30 个纯函数工具组）。 */
const groupSpecs: { id: string; titleKey: string; icon: Component }[] = [
  ...
  { id: 'functools', titleKey: 'tools.group.functools', icon: Hash }
]
