...
export namespace domain {
	...
	export class PetClickThroughREQ {
	    enabled: boolean;
	    rects: PetHitRect[];
	
	    static createFrom(source: any = {}) {
	        return new PetClickThroughREQ(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.enabled = source["enabled"];
	        this.rects = this.convertValues(source["rects"], PetHitRect);
	    }
	...
	export class PetConfigREQ {
	    ...
	    static createFrom(source: any = {}) {
	        return new PetConfigREQ(source);
	    }
	...
	export class PetConfigRESP {
	    ...
	    static createFrom(source: any = {}) {
	        return new PetConfigRESP(source);
	    }
	...
	export class PetSpriteREQ {
	    ...
	    static createFrom(source: any = {}) {
	        return new PetSpriteREQ(source);
	    }
	...
	export class PetSpriteRESP {
	    ...
	    static createFrom(source: any = {}) {
	        return new PetSpriteRESP(source);
	    }
	...
	export class WikiFileSummaryRESP {
	    path: string;
	    lang: string;
	    lines: number;
	    summary: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new WikiFileSummaryRESP(source);
	    }
	...
	export class WikiLangRESP {
	    lang: string;
	    files: number;
	    lines: number;
	
	    static createFrom(source: any = {}) {
	        return new WikiLangRESP(source);
	    }
	...
	export class WikiNodeRESP {
	    ...
	    lang?: string;
	    summary?: string;
	    children?: WikiNodeRESP[];
	
	    static createFrom(source: any = {}) {
	        return new WikiNodeRESP(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.lang = source["lang"];
	        this.summary = source["summary"];
	        this.children = this.convertValues(source["children"], WikiNodeRESP);
	    }
	...
	export class WikiOverviewRESP {
	    root: string;
	    name: string;
	    total_files: number;
	    total_lines: number;
	    langs: WikiLangRESP[];
	    entries: WikiFileSummaryRESP[];
	    tree: WikiNodeRESP[];
	
	    static createFrom(source: any = {}) {
	        return new WikiOverviewRESP(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.langs = this.convertValues(source["langs"], WikiLangRESP);
	        this.entries = this.convertValues(source["entries"], WikiFileSummaryRESP);
	        this.tree = this.convertValues(source["tree"], WikiNodeRESP);
	    }
	...
	export class WikiPageRESP {
	    path: string;
	    type: string;
	    lang?: string;
	    lines: number;
	    summary: string;
	    children?: WikiFileSummaryRESP[];
	    content?: string;
	    truncated?: boolean;
	
	    static createFrom(source: any = {}) {
	        return new WikiPageRESP(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.lines = source["lines"];
	        this.summary = source["summary"];
	        this.children = this.convertValues(source["children"], WikiFileSummaryRESP);
	        this.content = source["content"];
	        this.truncated = source["truncated"];
	    }
